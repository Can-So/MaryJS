...
(function (app) {
    ...
    maryjs.inventoryServices = function ($q, db, product) {
    ...
    app.service("maryjs.inventoryServices",
        [
            "$q",
            "maryjs.inventoryDb",
            "maryjs.product",
...
(function (app) {
    ...
    maryjs.InventoryCtrl = function ($scope, focus, invSvc, product, productSvc) {
    ...
    app.controller("maryjs.InventoryCtrl",
        [
            "$scope",
            "maryjs.focus",
            "maryjs.inventoryServices",
            ...
            maryjs.InventoryCtrl
        ]
    );
}(angular.module("maryjs.app")));
(function (app) {
    app.factory("maryjs.order", function () {
    ...
    app.factory("maryjs.orderCalculator", ["maryjs.settings", "maryjs.productService", function (settings, productSvc) {
        return {
...
(function (app) {
    ...
    maryjs.orderServices = function ($q, db, order) {
    ...
    app.service("maryjs.orderServices",
        [
            "$q",
            "maryjs.ordersDb",
            "maryjs.order",
...
(function (app) {
    ...
    maryjs.CreateOrderCtrl = function ($scope, focus, invSvc, product, orderSvc, orderCalculator, order, productSvc) {
        $scope.code = "";
    ...
    app.controller("maryjs.CreateOrderCtrl", [
        "$scope",
        "maryjs.focus",
        "maryjs.inventoryServices",
        "maryjs.product",
...
(function (app) {
    ...
    maryjs.labelsServices = function ($filter, settings, productSvc, invSvc, writer) {
    ...
    app.service("maryjs.labelsServices", 
        [
            "$filter",
            "maryjs.settings",
            "maryjs.productService",
